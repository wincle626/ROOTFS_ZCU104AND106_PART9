...
# #!/usr/bin/env perl
# $Id: tlmgr.pl 53568 2020-01-27 18:20:16Z karl $
#
# Copyright 2008-2020 Norbert Preining
# This file is licensed under the GNU General Public License version 2
# or any later version.

my $svnrev = '$Revision: 53568 $';
my $datrev = '$Date: 2020-01-27 19:20:16 +0100 (Mon, 27 Jan 2020) $';
my $tlmgrrevision;
my $tlmgrversion;
my $prg;
my $bindir;
...
sub init_local_db {
  ...
  if (!defined($localtlpdb)) {
    if ($should_i_die == 2) {
      ...
      if ($opts{'usermode'}) {
        die("$prg: running in usermode, did you call `tlmgr init-usertree'?\n");
      } else {
